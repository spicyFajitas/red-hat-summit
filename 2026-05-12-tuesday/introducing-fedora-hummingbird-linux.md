...
Fedora Hummingbird Linux is a new distribution; a community-driven, rolling release that ships the latest upstream software— freely available, freely redistributable, with no registration required.
...
What makes Fedora Hummingbird Linux architecturally distinct from traditional Fedora and enterprise Linux distributions.
Who it's built for.
Where it fits in a modern infrastructure stack.
You will leave ready to download Fedora Hummingbird Linux, with a clear path to joining the Fedora community and helping shape its future.

Scottt McCarty, Senior Principal Product Manager - RHEL, Red Hat

Stef Walter, Senior Director RHEL and Linux Engineering, Red Hat
